            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 chef-profile-details">
                    ...
                    <ul class="tabs-left">
                        ...
                        <li><a class="section-sub-title" href="#Tab-3" data-toggle="tab">My Favorites</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="Tab-2">
                            <div class="tab-section">
                                ...
                                <h4 class="head-title">All Orders</h4>
                                ...
                                <table class="table table-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-title="Order ID">6364838399</td>
                                            <td data-title="Date">May 19, 2015</td>
                                            <td data-title="Status" class="numeric">Pending</td>
                                            <td data-title="" class="numeric"><a href="javascript:;">View Details</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-title="Order ID">6364838399</td>
                                            <td data-title="Date">May 19, 2015</td>
                                            <td data-title="Status" class="numeric">Delivered</td>
                                            <td data-title="" class="numeric"><a href="javascript:;">View Details</a>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="tab-pane" id="Tab-3">
                            <h5 class="section-sub-title">My Favorites</h5>
                        </div>
                        <div class="tab-pane" id="Tab-6">
                            <h5 class="section-sub-title">Logout</h5>
                        </div>
                    </div>
                </div>
            </div>
